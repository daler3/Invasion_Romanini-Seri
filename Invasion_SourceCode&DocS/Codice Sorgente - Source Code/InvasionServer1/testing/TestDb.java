...
public class TestDb {
	...
	private final static String utenteDelete ="aa";
	private final static String userLogin ="sd";
	private final static String pwLogin ="sd";
	private final static String pwLogin0 ="rt";
	private final static String userLogin1 ="rt"; //
	private final static String pwLogin1 ="fg";
	private final static String userReg ="q";
	private final static String pwReg ="q";
	private final static String userReg1 ="w1";
	private final static String pwReg1 ="w1";
